...
with DAG(
    ...
    t1 = DataTransferPostgres(
        ...
        task_id='customer',
        source_pg_conn_str="host='etl_postgres_01' port=5432 dbname='kurs_db' user='root' password='postgres'",
        pg_conn_str="host='etl_postgres_02' port=5432 dbname='kurs_db' user='root' password='postgres'",
    )
